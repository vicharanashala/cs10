...
- **Community Spotlight** — Questions that are open, have zero answers, and are older than 2 minutes are auto-flagged as spotlighted and shown in a dedicated urgent section.
...
- **Pinned Questions** — Admin-pinned questions always appear at the top with distinct golden-border styling.
...
- **SP (Samagama Points)** — Earned for posting questions, submitting answers (0/5/10/15 SP tiers), upvotes, approval, and corpus promotion. Balance never goes below zero.
